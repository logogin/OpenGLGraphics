...
main(int argc, char **argv)
{
  ...
  glNewList(1, GL_COMPILE);
    /* Render red hill. */
    glMaterialfv(GL_FRONT, GL_DIFFUSE, /*mat_red_diffuse*/mat_yellow_diffuse);
    ...
    /* Render green hill. */
    glMaterialfv(GL_FRONT, GL_DIFFUSE, /*mat_green_diffuse*/mat_yellow_diffuse);
    gluBeginSurface(nurb);
      gluNurbsSurface(nurb, 8, knots, 8, knots,
        4 * 3, 3, &pts2[0][0][0],
        4, 4, GL_MAP2_VERTEX_3);
    ...
    /* Render blue hill. */
    glMaterialfv(GL_FRONT, GL_DIFFUSE, /*mat_blue_diffuse*/mat_yellow_diffuse);
    gluBeginSurface(nurb);
      gluNurbsSurface(nurb, 8, knots, 8, knots,
        4 * 3, 3, &pts3[0][0][0],
        4, 4, GL_MAP2_VERTEX_3);
