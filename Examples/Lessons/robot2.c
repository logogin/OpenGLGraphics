/* 
* 
* 'robot1.c' program with additional arm. 
* 
*/
...
#define END_ARM_HEIGHT 2.0
#define END_ARM_WIDTH 0.5
...
void end_arm() {
	glPushMatrix();
	glTranslatef(0.0, 0.5*END_ARM_HEIGHT, 0.0);
	glScalef(END_ARM_WIDTH, END_ARM_HEIGHT, END_ARM_WIDTH);
	glutWireCube(1.0);
	glPopMatrix(); }
